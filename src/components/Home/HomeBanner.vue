...
const imgDatas = [
  {
    id: '1',
    name: 'HTML',
    src: require('@/assets/imgs/banner/001.png'),
    url: '/categories/1000000000'
  },
  {
    id: '2',
    name: 'CSS',
    src: require('@/assets/imgs/banner/002.png'),
    url: '/categories/1100000000'
  },
  {
    id: '3',
    name: 'JavaScript',
    src: require('@/assets/imgs/banner/003.png'),
    url: '/categories/1200000000'
  },
  {
    id: '4',
    name: 'Vue',
    src: require('@/assets/imgs/banner/004.png'),
    url: '/categories/1403000000'
  },
  {
    id: '5',
    name: 'React',
    src: require('@/assets/imgs/banner/005.png'),
